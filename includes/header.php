<nav class="navbar navbar-inverse  navbar-fixed-top "style="background-color:#34495E">
	 
	    <div class="container-fluid">
		  <div class="navbar-header ">
		     <a href="#" class="navbar-brand" style="color:white; font-size:35px; font-style:Verdana">ANANTHAM</a>
		  </div>
		  <ul class="nav navbar-nav navbar-center" style="color:orange">
			...
			<!-- <li class="dropdown"><a href="OurPillars.php" class="dropdown-toggle" data-toggle="dropdown">Our Pillars<span class="caret"></span></a>
			    <ul class="dropdown-menu">
				   <li><a href="#">Classroom Programs</a></li>
				   <li><a href="#">Holistic Development</a></li>
				   <li><a href="#">Vocational Hub</a></li>
				   <li><a href="#">Shout out</a></li>
				</ul>
			 </li>-->
			 <li><a href="ourNetwork.php">Our Network</a></li>
